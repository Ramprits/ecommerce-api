...
export class AuthService {
    constructor(private readonly jwt: JwtService, private userService: UsersService) { }
    ...
    buildRegisterResponse(arg0: CreateUserDto & UserEntity): UserResponse | PromiseLike<UserResponse> {
